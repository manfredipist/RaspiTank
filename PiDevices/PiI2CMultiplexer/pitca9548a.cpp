...
void PiTCA9548A::initializeFrontLaser(){
    piVL53L1X_F = new PiVL53L1X(i2c_bus,i2c_vl53l1x_address);
    i2c->writeBit16(i2c_multiplexer_address, piVL53L1X_F_bus, 0x1);
    piVL53L1X_F->initialize();
}
...
double PiTCA9548A::getFrontLaser(){
    ...
    i2c->writeBit16(i2c_multiplexer_address, piVL53L1X_F_bus, 0x1);
    return piVL53L1X_F->getDistance();
}
